  ...
  return (
    <main className="flex flex-col items-center justify-center h-screen bg-gray-950 bg-radial-[at_0%_0%] from-gray-900 via-gray-800 to-gray-950">
      ...
      <div>
        ...
        <Link href="https://github.com/jakeojeff/stacks-against-you" className="ml-2 font-bold text-white p-2 pl-4 pr-4 rounded-t-full  hover:bg-amber-300 hover:text-gray-950/50 duration-500">Mode</Link>
