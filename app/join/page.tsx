...
export default function Join() {
    ...
    return (
        <main className="flex flex-col items-center justify-center h-screen bg-gray-950 bg-radial-[at_0%_0%] from-gray-900 via-gray-500 to-gray-950">
            <div><div className="flex flex-col p-8 sm:p-12 md:container items-center bg-gray-900/25 backdrop-blur-lg rounded-2xl shadow-2xl border border-gray-700 text-center">
                <input
                    type="text"
                    placeholder="Enter Username"
                    value={userName}
                    onChange={(e) => setUserName(e.target.value)}
                    className="rounded-t-3xl rounded-b-2xl text-white border-white w-64 px-4 py-2 mb-2 border-2 "
                />
                <input
                    type="text"
                    ...
                    className="rounded-b-3xl rounded-t-2xl text-white border-white w-64 px-4 py-2 mb-4 border-2 "
                />
